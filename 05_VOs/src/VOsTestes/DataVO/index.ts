...
export function TestaDataHoraVO() {
  ...
  const data1 = new DataHoraVO("2023-06-15");
  const data2 = new DataHoraVO("2024-06-15T00:00");
  const data3 = new DataHoraVO(new Date());
  ...
  console.log("data1 isEqual to 2023-06-15?", data1.isEqual(new DataHoraVO("2023-06-15")));
